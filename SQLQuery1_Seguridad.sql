...
VALUES 
(1, 'Carlos', 'Gómez', 32456789, 'Av. Siempre Viva 123, Buenos Aires', '20-32456789-3', 'carlos.gomez@email.com', 'cgomez@empresa.com', 'Mañana', 'Analista de Datos', 1),
(2, 'Mariana', 'López', 29876543, 'Calle Falsa 456, Córdoba', '27-29876543-5', 'mariana.lopez@email.com', 'mlopez@empresa.com', 'Tarde', 'Desarrolladora', 2);
...
SELECT id_empleado, 
       ...
       CONVERT(INT, DECRYPTBYPASSPHRASE('Xg7#pV@1zK$9mTqW', dni_enc)) AS dni,
