...
--prueba para SP insertarEmpleado, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
--prueba para SP insertarProveedor, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
--prueba para SP insertarProducto, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
-- prueba para SP insertarProvee, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
-- prueba para SP insertarMedioPago, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
-- prueba para SP insertarPedido, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
-- prueba para SP insertarVenta, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
-- prueba para SP insertarTiene, Ejecute los siguientes juegos de prueba
-- datos invalidos
...
-- prueba para SP insertarFactura, Ejecute los siguientes juegos de prueba
-- datos invalidos
